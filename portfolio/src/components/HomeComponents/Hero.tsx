    ...
    <div className="relative h-screen w-full overflow-hidden bg-blue-500">
      ...
      <div className="absolute top-[100px] left-0 w-full flex flex-col items-center gap-0 pointer-events-auto z-10">
        <motion.div
          ...
          className="text-lg text-background relative top-8"
        >
        ...
        <motion.div 
          ...
          className="relative inline-block m-0 -top-4"
        >
          <p className="text-[200px] font-bold m-0 tracking-widest cursor-none font-mid text-background uppercase">Nimna Pathum</p>
          <p className="absolute -top-1 -left-1 m-0 select-none tracking-widest pointer-events-none cursor-none font-mid text-[200px] font-bold text-accent uppercase">Nimna Pathum</p>
        </motion.div>
        ...
        >
            ...
            <div className="flex flex-col justify-end items-end">
              ...
              <div className="w-[460px] text-end mt-3 inline-flex flex-col gap-2">
                ...
                >
                  I`m a <span className="text-xl font-semibold">passionate developer</span> with a strong foundation in software engineering and hands-on experience across PHP, MERN, and Java Spring Boot. I enjoy solving problems, building real-world applications, and exploring cloud, AI agents, and DevOps.
                </motion.span>
                <motion.span
                  initial={{ opacity: 0, x: 50 }}
                  animate={{ opacity: 1, x: 0 }}
                ...
                >
                  I`m always <span className="text-xl font-semibold">eager to learn</span>, collaborate, and grow—currently preparing for research in Agentic AI while continuing to refine my technical skills.
                </motion.span>
              </div>
